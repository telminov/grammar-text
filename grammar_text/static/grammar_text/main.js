...
(function() {
  var PHRASE_MOVE_LEFT_EVENT, PHRASE_MOVE_RIGHT_EVENT, PHRASE_REMOVE_EVENT, PHRASE_SELECTED_EVENT, PhraseElement, Suggest, createSuggestElement, getLeftPadding, grammarInputPrepare, suggestInputPrepare;
  ...
  this.GrammarText = (function() {
    ...
    GrammarText.prototype._setInputFocus = function() {
      var input, inputs, j, len;
    ...
    GrammarText.prototype._renderInputs = function() {
      var input, inputs, j, len, scrollWidth, tmpInput;
      inputs = this.el.find("input");
      for (j = 0, len = inputs.length; j < len; j++) {
        input = inputs[j];
        input = $(input);
      ...
      return this.width = this.el.outerWidth(true);
    };
