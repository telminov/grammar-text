...
(function() {
  var PHRASE_COMPLETE_EVENT, PHRASE_MOVE_LEFT_EVENT, PHRASE_MOVE_RIGHT_EVENT, PHRASE_REMOVE_EVENT, PHRASE_SELECTED_EVENT, PHRASE_WIDTH_CHANGED_EVENT, PhraseElement, Suggest, createSuggestElement, getLeftPadding, grammarInputPrepare, suggestInputPrepare;
  ...
  PhraseElement = (function() {
    ...
    PhraseElement.prototype._renderInputs = function() {
      var e, input, inputs, j, len, newWidth, scrollWidth, tmpInput;
      inputs = this.el.find("input");
      for (j = 0, len = inputs.length; j < len; j++) {
        input = inputs[j];
        input = $(input);
