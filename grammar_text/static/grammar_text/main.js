...
(function() {
  var Suggest, createPhraseElement, createSuggestElement, getLeftPadding, grammarInputPrepare, suggestInputPrepare;
  ...
  Suggest = (function() {
    ...
    Suggest.prototype.refresh = function() {
      var filterText, j, k, len, len1, phrase, phraseElement, phraseText, phrases, ref;
      if (!this.isOpened) {
        return;
      }
  ...
  this.GrammarText = (function() {
    ...
    GrammarText.prototype.clearSelection = function() {
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        phraseElement = ref[j];
        results.push(phraseElement.removeClass('selected'));
      }
      return results;
    };
    ...
    GrammarText.prototype.removePhrase = function(phraseElement) {
      var deleteIndex, el, i, inputPadding, j, k, left, len, len1, newInputPadding, phrasePadding, rawLeft, ref, ref1, selectedIndex;
      deleteIndex = void 0;
      ref = this.phraseElements;
    ...
    GrammarText.prototype.selectLastPhrase = function() {
      ...
      return lastPhraseElement.addClass('selected');
    };
    ...
    GrammarText.prototype.selectPhraseByIndex = function(index) {
      ...
      return phraseElement.addClass('selected');
    };
